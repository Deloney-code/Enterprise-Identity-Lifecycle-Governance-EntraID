...
$UsersExport = "C:\medcare-iam-lab\evidence\07-post-remediation\all-users-export.csv"
$Memberships = "C:\medcare-iam-lab\evidence\07-post-remediation\group-memberships.csv"
$OutDir      = "C:\medcare-iam-lab\evidence\07-post-remediation"
